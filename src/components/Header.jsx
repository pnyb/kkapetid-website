  ...
  return (
    ...
    >
      ...
      <div className="relative text-center text-white px-6 max-w-3xl">
        ...
        <p className="mb-8 text-lg md:text-xl drop-shadow-md font-serif">
          A place where friends become family over food and conversation.
        </p>
        <a
          href="#menu"
          className="px-6 py-3 bg-brand-medium text-white font-montserrat font-bold uppercase tracking-widest text-sm rounded-full hover:bg-brand-dark transition"
        >
          Explore Our Menu
        </a>
      </div>
